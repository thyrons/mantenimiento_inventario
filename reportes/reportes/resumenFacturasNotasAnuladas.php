...
session_start();
    ...
    <body>
        ...
        <hr>
        <div id="linea">
            <h3>RESUMEN DE FACTURAS Y NOTAS DE VENTAS ANULADAS </h3>
        </div>';
            ...
            if($contador > 0){
                ...
                while($row1=pg_fetch_row($consulta1)){                     
                    ...
                    if($repetido==0){                        
                        ...
                        <td style="width:70px">Fecha Anulación</td>
    ...
    $dompdf->stream('resumenFacturasNotasAnuladas.pdf',array('Attachment'=>0));
?>